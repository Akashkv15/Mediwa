...
function Register() {
  ...
  const addmember =async (event)=>{
    ...
    const body={name,address,email,password,number,confirm}
    try{
        const result =await axios.post('http://localhost:8000/addmember',body)
        console.log(result);
      ...
      <div className="form-container">
        <div className="form-wrapper">
          ...
          <div className="form-content">
            ...
            <button className='submit-button' onClick={addmember}>Register</button>
          </div>
        </div>
      </div> 
    </div>
